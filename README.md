...
- Follow the steps for "Installing dependencies" for "Building Projects with Native Code" (not the "Quick Start"):
    ...
    - The Android NDK should also be installed through the SDK Manager (as is done by default). If it is not, see ["Download the NDK and Tools"](https://developer.android.com/ndk/guides/index.html#download-ndk).
