...
export default class FormInput extends Component {
  ...
  static propTypes = {
    ...
    suppressPinTooShort: PropTypes.bool,
  }
  ...
  renderError() {
    const { validationForced, inputType, suppressPinTooShort } = this.props;
    const { value } = this.state;

    if (!validationForced || inputType !== 'pin' || suppressPinTooShort)
      return null;
