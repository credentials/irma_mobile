export default {
  ...
  LogDashboard: {
    title: 'Geschiedenis',
    issuing: {
      title: 'Attributen ontvangen van {{serverName}}',
      header: 'Ontvangen attributen',
    },
    disclosing: {
      title: 'Attributen vrijgegeven aan {{serverName}}',
      header: 'Vrijgegeven attributen',
    },
    signing: {
      title: 'Bericht ondertekend en attributen vrijgegeven aan {{serverName}}',
