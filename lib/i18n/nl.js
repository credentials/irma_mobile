export default {
  ...
  Session: {
    ...
    IssuanceSession: {
      ...
      requestPermissionExplanation: ' wil de volgende attributen aan u uitgeven:',
      requestDisclosurePermission: {
        before: 'Voordat u de attributen uit het vorige scherm ontvangt, moet u onderstaande attributen vrijgeven aan ',
        after: '',
      },
      cancelledExplanation: 'Attributen ontvangen geannuleerd',
    ...
    DisclosureSession: {
      ...
      requestPermissionExplanation: 'vraagt u onderstaande attributen vrij te geven:',
      cancelledExplanation: 'Attributen vrijgeven geannuleerd',
    ...
    SigningSession: {
      ...
      requestPermission: {
        before: 'verzoekt u om het volgende bericht te ondertekenen:',
        after: 'met de volgende attributen:',
      },
      cancelledExplanation: 'Ondertekenen geannuleerd',
      success: {
        before: 'U heeft het volgende bericht ondertekend:',
        after: 'met de volgende attributen:',
      },
    ...
    Disjunction: {
      noValue: 'niets',
      emptyConjunction: 'Geen attributen geselecteerd',
      emptyConjunctionNote: 'Meer opties zijn beschikbaar',
  ...
  ErrorCard: {
    types: {
      ...
      configurationDownload: 'Er is iets misgegaan tijdens de communicatie met de IRMA server.\n\nHeeft u een werkende internetverbinding?',
      unknownSchemeManager: 'De sessie kan niet worden uitgevoerd omdat de scheme "{{errorInfo}}" onbekend is.',
      unknownIdentifier: 'De IRMA server stuurde een ongeldig verzoek.',
      invalidRequest: 'De IRMA server stuurde een ongeldig verzoek.',
      crypto: 'Er is iets misgegaan tijdens de IRMA sessie.',
      ...
      keyshare: 'Er is iets misgegaan tijdens de IRMA sessie.',
  ...
  AppUnlock: {
    title: 'Voer uw IRMA PIN in',
    checkingPin: 'Pin aan het controleren',
  },
  UpdateModal: {
    title: 'Update nodig',
    outofdate: 'Voor verder gebruik van de IRMA app is het nodig de laatste versie te installeren. Je kunt deze installeren vanuit de app store van jouw platform.',
    update: 'Update',
  },
  LogDashboard: {
    title: 'Geschiedenis',
    issuing: {
      title: 'Attributen ontvangen',
      serverName: 'van {{serverName}}',
      header: 'Ontvangen attributen',
    },
    disclosing: {
      title: 'Attributen vrijgegeven',
      serverName: 'aan {{serverName}}',
      header: 'Vrijgegeven attributen',
    },
    signing: {
      title: 'Bericht ondertekend en attributen vrijgegeven',
      serverName: 'aan {{serverName}}',
      header: 'Ondertekend bericht'
    },
    removal: {
      title: 'Attributen uit de app verwijderd door u',
      header: 'Verwijderde attributen'
    },
    atTime: 'op {{time}}',
    noLogs: 'Geschiedenis is nog leeg',
  },
};
