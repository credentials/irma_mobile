export default {
  ...
  Enrollment: {
    ...
    step2: {
      ...
      text: 'Associeer een e-mailadres met uw account. Dit is optioneel maar wel aangeraden. Hiermee kunt u inloggen in uw MijnIRMA omgeving mocht uw telefoon kwijtraken of gestolen worden, zodat u uw IRMA account kunt sluiten.',
      label: 'E-mailadres',
  ...
  Session: {
    StatusCard: {
      ...
      explanation: {
        requestPin: 'Om uw attributen te gebruiken, voer uw IRMA PIN in.',
        registerMyIrma: 'IRMA account opnenen',
