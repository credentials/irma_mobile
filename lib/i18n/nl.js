export default {
  ...
  About: {
    ...
    attributions: 'De achtergrondafbeeldingen van de drie introductieschermen zijn gemaakt door Lexamer, Photoroyalty en Blossomstar respectievelijk, van Freepik.com.',
  },
  CredentialDashboard: {
    noAttributes: {
  ...
  Enrollment: {
    ...
    step2: {
      ...
      text: 'Koppel een e-mailadres aan uw account. Dit is niet verplicht, maar wordt wel sterk aangeraden. Hiermee kunt u inloggen op MijnIRMA om uw account te sluiten, in het geval dat uw telefoon gestolen wordt of kwijt raakt.',
      label: 'E-mailadres',
  ...
  Session: {
    StatusCard: {
      ...
      explanation: {
        ...
        keyshareEnrollmentMissing: 'Voordat u attributen kunt ontvangen en vrijgaven moet u een IRMA account openen.',
