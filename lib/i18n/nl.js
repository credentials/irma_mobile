export default {
  ...
  Session: {
    ...
    DisclosureSession: {
      ...
      requestPermissionPhoneExplanation: 'vraagt u de onderstaande attributen vrij te geven om een telefoongesprek te starten met {{phoneNumber}}',
  ...
  CredentialCard: {
    ...
    refresh: 'Verversen',
    disallowedDelete: 'Deze attributen kunnen niet worden verwijderd.',
  },
  CollapsableForm: {
    skip: 'Overslaan',
    next: 'Volgende',
