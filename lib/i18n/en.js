export default {
  ...
  Enrollment: {
    ...
    stepOne: {
      ...
      text: 'Before you can use the IRMA app, you need to register with MyIRMA.\n\nBy using the MyIRMA webpage, you can block further usage of your IRMA attributes in case your device is lost or stolen.\n\nYou will receive an e-mail with a link at the address you enter here.\n\nBy clicking on this link and scanning the QR code, you will receive your first attributes.'
    },
    stepTwo: {
      label: 'PIN',
  ...
  Session: {
    ...
    Error: {
      ...
      unknownSchemeManager: 'The request can\'t be understood because it uses an unknown scheme manager "{{manager}}".',
      unknown: 'An unknown error occurred. If this persists, please contact IRMA.'
    },
    PinEntry: {
      label: 'IRMA PIN',
