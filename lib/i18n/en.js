export default {
  ...
  CredentialDashboard: {
    noAttributes: {
      ...
      text: 'If you just registered with IRMA, you can obtain your first attributes by clicking on the link sent to you by e-mail.'
    },
    unenrolled: {
      header: 'Please register with IRMA',
      text: 'You are not registered at IRMA yet.\nYou need to do so to use attributes.',
      button: 'Register with IRMA',
    },
  ...
  Session: {
    ...
    Error: {
      codes: {
        ...
        keyshare: 'Something went wrong in the IRMA protocol.',
  ...
  Sidebar: {
    ...
    register: 'Register with IRMA',
    deleteAll: {
      menu: 'Delete all attributes',
      title: 'Delete all attributes?',
      message: 'Are you sure you want to delete all attributes? This will also unregister you from IRMA.\n\nNote: if you would like to re-register using the same email address, you will need to delete your IRMA account at the IRMA website.',
      ok: 'Delete',
      cancel: 'Cancel',
    }
  },
