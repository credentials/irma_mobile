export default {
  ...
  Session: {
    ...
    Error: {
      ...
      persists: 'If this persists, please contact IRMA using the buttons below.',
      unknown: 'An unknown error occurred.',
      hideinfo: 'Hide report',
      showinfo: 'Show report',
      explanation: 'If you press \'Report to IRMA\' the following information will be reported.',
