export default {
  ...
  ErrorCard: {
    types: {
      ...
      configurationDownload: 'Something went wrong while communicating with the IRMA server.\n\nDo you have a working internet connection?',
      unknownSchemeManager: 'The request can\'t be understood because it uses an unknown scheme "{{errorInfo}}".',
      unknownIdentifier: 'The IRMA server sent an invalid request.',
      invalidRequest: 'The IRMA server sent an invalid request.',
      crypto: 'Something went wrong during the IRMA session.',
      ...
      keyshare: 'Something went wrong during the IRMA session.',
  ...
  UpdateModal: {
    ...
    outofdate: 'In order to continue using IRMA, you will need to update this app. You can update this IRMA app from the app store where you originally obtained it.',
    update: 'Update',
  },
  LogDashboard: {
    title: 'History',
    issuing: {
      title: 'Attributes issued by {{serverName}}',
      header: 'Attributes received',
    },
    disclosing: {
      title: 'Attributes disclosed to {{serverName}}',
      header: 'Attributes disclosed',
    },
    signing: {
      title: 'Signed message and attributes disclosed to {{serverName}}',
      header: 'Signed message',
    },
    removal: {
      title: 'Attributes removed from the app by you',
      header: 'Removed attributes',
    },
    atTime: 'at {{time}}',
    noLogs: 'History is empty yet',
  },
};
