...
export const APP_UPDATE_SCREEN = 'irma.APP_UPDATE_SCREEN';
...
export const registerScreens = () => {
  ...
  registerComponentWithProviders(APP_UPDATE_SCREEN, () => require('components/UpdateModal').default);
...
export const showAppUpdateModal = ({showModalAnimation = true} = {}) => {
  Navigation.showModal({
    stack: {
      children: [{
        component: {
